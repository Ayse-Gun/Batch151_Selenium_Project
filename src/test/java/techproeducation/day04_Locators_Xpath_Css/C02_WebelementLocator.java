package techproeducation.day04_Locators_Xpath_Css;
...
public class C02_WebelementLocator {
    ...
    public static void main(String[] args) {
        ...
        // Ex : https://www.amazon.com sayfasına gidiniz
        driver.get("https://amazon.com");

        // arama kutusuna "city bike" yazıp aratın
        driver.findElement(By.id("twotabsearchtextbox")).sendKeys("city bike", Keys.ENTER);// klavye islemleri

        // sonuc yazısını yazdırın
        List<WebElement> sonucYazisi = driver.findElements(By.className("sg-col-inner"));
        System.out.println(sonucYazisi.get(0).getText()); // listin icindeki 0. web elementi verecek bize
        // 1-16 of 158 results for "city bike"

        // sonuc sayısını yazdırın
        String [] sonucSayisi = sonucYazisi.get(0).getText().split(" ");
        System.out.println("sonucSayisi = " + sonucSayisi[2]);   // sonucSayisi = 155

        // yada Xpath ile List kullanmadan ek seferde locate aldik
        ...
        System.out.println(ilkUrun.isSelected());  // False doner cunku ilk urun secilme oz. sahip degil yani select butonu yok
