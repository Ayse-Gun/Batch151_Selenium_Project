package techproeducation.day06_relativeLocators;
...
public class C01_relativeLocators {
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        */
        ...
        // bu yontemlede bulunabilir
        List<WebElement> linlkerListesi2 = driver.findElements(By.xpath("(//*[@class='a-list-item'])[position()>=9 and position()<=15]"));
